...
class AppStyles {
  // Warna brand di-set saat compile lewat --dart-define, BUKAN lewat static
  // mutable + configure() saat runtime: primaryColor dipakai di ~139 tempat,
  // banyak di antaranya sebagai argumen `const` constructor (mis.
  // `const BorderSide(color: AppStyles.primaryColor)`), jadi nilainya harus
  // tetap compile-time constant.
  //
  // Tiap app memasang --dart-define=APP_PRIMARY_COLOR=0xAARRGGBB saat
  // run/build (lihat melos.yaml & .vscode/launch.json). Default di bawah =
  // biru FixTrack, jadi app yang tidak memasang define ini tetap dapat warna
  // yang sama seperti sebelum monorepo.
  static const int _primaryValue = int.fromEnvironment(
    'APP_PRIMARY_COLOR',
    defaultValue: 0xFF386AD8,
  );
  static const Color primaryColor = Color(_primaryValue);
  static const Color darkRedColor = Color(0xFFC43A3A);
  static const Color bgColor = Color(0xFFFCFCFC);
  static const Color whiteColor = Colors.white;
  static const Color blackColor = Colors.black87;
  // Biru semantik (polyline rute di peta) — kebetulan sama dengan biru
  // FixTrack, tapi SENGAJA tidak ikut primaryColor: rute tetap biru walaupun
  // brand app-nya merah.
  static const Color blueColor = Color(0xFF386AD8);
  static const Color textBlackColor = Color(0xFF3A3A3A);
  ...
  static const Color darkGrayColor = Color(0xFF7B7B7B);
  ...
  static const TextStyle textL = TextStyle(fontSize: 22, color: textBlackColor);
