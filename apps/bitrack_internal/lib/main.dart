...
/// Warna brand Bitrack Internal. Nilai ini TIDAK dipakai untuk mewarnai apa pun —
...
const _brandPrimaryColor = 0xFF9E2021;

Future<void> main() async {
  WidgetsFlutterBinding.ensureInitialized();
  assert(
    AppStyles.primaryColor.toARGB32() == _brandPrimaryColor,
    'APP_PRIMARY_COLOR tidak ter-set ke 0xFF9E2021. Jalankan lewat '
    '`melos run internal` atau tambahkan sendiri '
    '--dart-define=APP_PRIMARY_COLOR=0xFF9E2021 ke perintah flutter run/build.',
  );
  // Identitas brand Bitrack Internal, dibaca kode shared di bitrack_core. Warna
  ...
  // bitrack_core/base/res/styles/app_styles.dart untuk alasannya: dipakai di
  // ratusan `const` constructor, jadi harus compile-time constant).
  // splashLogoSize: logo Bitrack Internal lebih kotak, jadi yang membatasi tingginya, bukan
  // lebarnya.
  AppBranding.configure(
    appName: 'Bitrack Internal',
    mapUserAgentPackageName: 'com.treffix.bitrack',
    splashLogoSize: const Size(180, 180),
  );
