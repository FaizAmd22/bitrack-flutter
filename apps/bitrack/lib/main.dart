...
/// Warna brand Bitrack. Nilai ini TIDAK dipakai untuk mewarnai apa pun —
...
const _brandPrimaryColor = 0xFFD84040;

Future<void> main() async {
  WidgetsFlutterBinding.ensureInitialized();
  assert(
    AppStyles.primaryColor.toARGB32() == _brandPrimaryColor,
    'APP_PRIMARY_COLOR tidak ter-set ke 0xFFD84040. Jalankan lewat '
    '`melos run bitrack` atau tambahkan sendiri '
    '--dart-define=APP_PRIMARY_COLOR=0xFFD84040 ke perintah flutter run/build.',
  );
  // Identitas brand Bitrack, dibaca kode shared di bitrack_core. Warna
  ...
  // splashLogoSize: logo Bitrack lebih kotak, jadi yang membatasi tingginya, bukan lebarnya.
  AppBranding.configure(
    appName: 'Bitrack',
    mapUserAgentPackageName: 'com.bitrack.mobile',
